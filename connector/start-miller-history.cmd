@echo off
setlocal
set "script_file=%~dp0miller-history-export.ps1"
set "error_file=%~dp0startup-error.txt"

if not exist "%script_file%" (
  echo Required file miller-history-export.ps1 was not found.
...
if not "%result%"=="0" (
  echo The read-only history export could not start.
